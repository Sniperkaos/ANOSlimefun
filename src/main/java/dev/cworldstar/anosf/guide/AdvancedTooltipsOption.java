...
public class AdvancedTooltipsOption implements SlimefunGuideOption<Boolean> {
	...
	public @NotNull NamespacedKey getKey() {
		return ANOSF.key("ADVANCED_TOOLTIPS_OPTION");
	}
	...
	public Optional<ItemStack> getDisplayItem(Player p, ItemStack guide) {
        ...
        item.editMeta(meta -> {
        	meta.displayName(FormatUtils.mm("<gray>Advanced Tooltips: " + optionState + "."));
            ArrayList<Component> lore = new ArrayList<Component>();
            lore.add(FormatUtils.empty());
            lore.add(FormatUtils.mm("<gray>Click to enable whether or not"));
            lore.add(FormatUtils.mm("<gray>advanced tooltips will appear on"));
           	lore.add(FormatUtils.mm("<gray>ANOSF items."));
            lore.add(FormatUtils.empty());
